...
import br.com.generics.sobrecarga.SobCarg;
...
public class Enca {
    ...
    public static void main(String[] args) {
        ...
        Encapsu ec = new Encapsu(name, price);

        ec.setName("Nome que deseja ser alterado!");
        ...
        nomes das variaveis parametrizada no SysOut/Inicializada ela refere a class/atributo Encapsu.

...
public class ExempExpressLogic {
    ...
    public static void main(String[] args) {
        ...
        /*
        if significa que se uma coisa com a lgica ou a comparacao de dados declarada dentro dela. Caso seja o esperado
        ...
        Os sinais de "E" comerciais(&&), é uma logica de progamacao, que se resulta apenas se duas condicoes estao verdadeiras
         ...
         */
        if (!(x <= 20 && x == 10)) { //essa logica sem o sinal de esclamacao(!) equivale a falso, sendo assim com o sinal de esclamacao a logica fica verdadeiro
